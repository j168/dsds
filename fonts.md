...
<img src="images/2018-02-13_134647.jpg" width=880 >
 ...
 <h4 style="text-align: center;"> 建议您各种翻墙(破网)软件轮换用；旧版本的翻墙软件也留存，有时候新版本的不好用试试旧版本的说不定还能行。封锁较严重地区，找到代理服务器的时间可能稍长。
</h4>

<div>
<p font-family: arial, monospace; "> 建议您各种翻墙(破网)软件轮换用；旧版本的翻墙软件也留存，有时候新版本的不好用试试旧版本的说不定还能行。封锁较严重地区，找到代理服务器的时间可能稍长。
</p>
        </div>
