...
。
	■ 您只需要一台短波收音机, 既可接收外界讯息, 简便快速。
	
	■ 接收方法: 准备一个数字选台式短波收音机, 可以6M-18M 中间搜寻可接收的频率。如果收听不清楚,  可移动收音机位置, 或使用天线, 调整天线方
向及角度、让天线尾端接触大型金属设施, 不行就再寻找其他可听的频率。
	
	■ 适用环境:  乡村以及二三级城市的郊外,  效果尤佳。
	
	■ 好处:  快捷 ,  不被封锁 ,  不需上网 ,  没有风险。
